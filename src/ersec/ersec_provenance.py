"""ERSEC 29.1.1 provenance and attestation-ready release statement.
...
def build(evidence: Mapping[str,Any], *, source_uri:str="", builder_id:str="ERSEC/29.1.1", invocation_id:str="", environment: Mapping[str,Any] | None = None)->dict[str,Any]:
    ...
    predicate={"buildType":"https://ersec.dev/provenance/29.1.1","builder":{"id":builder_id},
