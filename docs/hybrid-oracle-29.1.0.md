# ERSEC 29.1.0 — Hybrid Oracle & Runtime Control Correlation

ERSEC 29.1.0 now separates semantic response evidence from authoritative downstream evidence.
...
```bash
python ersec.py --hybrid-oracle examples/hybrid-semantic-29.1.0.json examples/hybrid-authoritative-29.1.0.json
```
...
```bash
python ersec.py --runtime-control-correlate examples/runtime-control-manifest-29.1.0.json examples/runtime-control-telemetry-29.1.0.json
```
