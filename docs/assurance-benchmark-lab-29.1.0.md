...
The 29.1.0 benchmark laboratory turns the roadmap's public/release/held-out corpus model into an executable, loopback-only evaluation harness. It measures authorization behavior against explicit reviewed ground truth and reports uncertainty instead of converting missing evidence into PASS.
