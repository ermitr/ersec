# ERSEC 29.1.0 CI Assurance Gate
...
python ersec.py --ci-assurance-gate \
  --ci-release-audit release-readiness-29.1.0.json \
  --ci-continuous continuous-assurance-29.1.0.json \
  --ci-release-evidence release-evidence-29.1.0.json \
  --ci-provenance provenance-29.1.0.json
```
