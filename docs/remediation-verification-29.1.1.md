...
ERSEC 29.1.1 now verifies remediation at the **security-property** level rather than treating alert disappearance as resolution.
...
python ersec.py --remediation-verify \
  ...
  --remediation-verify-out remediation-verification-29.1.1.json
```
