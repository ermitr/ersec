# ERSEC 29.1.1 — Stateful Security Behavior Assurance

ERSEC 29.1.1 adds a bounded stateful assurance compiler for reviewed business-flow invariants.
...
```bash
ersec --assurance-flow-compile examples/stateful-business-flow-29.1.1.yaml \
  --assurance-flow-out stateful-plan-29.1.1.json

ersec --assurance-flow-evaluate stateful-plan-29.1.1.json \
  examples/stateful-evidence-29.1.1.json \
  --assurance-flow-result-out stateful-result-29.1.1.json
```
