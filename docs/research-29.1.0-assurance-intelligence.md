# ERSEC 29.1.0 — Assurance Intelligence Research Direction

## Purpose

ERSEC 29.1.0 treats application security as an evidence problem, not a finding-count problem. This layer adds deterministic reasoning about **reality gaps, proof debt, evidence freshness, impact cones, and bounded next-best assurance actions**.
