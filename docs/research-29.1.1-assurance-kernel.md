# ERSEC 29.1.1 Deep Research Memo — Assurance Kernel
...
OWASP ASVS describes a standardized basis for testing web-application security controls and giving developers security requirements. ERSEC 29.1.1 converts that general verification mindset into explicit per-release proof obligations.
