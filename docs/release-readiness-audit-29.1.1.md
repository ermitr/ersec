...
It checks that the 29.1.1 assurance modules, release documentation, CI workflows,
...
```bash
python ersec.py --release-audit . --release-audit-out release-readiness-29.1.1.json
```
