...
Security-behavior properties are difficult to verify reproducibly when every test depends on manually prepared accounts and data. ERSEC 29.1.1 introduces a deterministic fixture-planning boundary that turns a reviewed identity/resource/operation specification into a disposable test manifest and explicit oracle truth.
