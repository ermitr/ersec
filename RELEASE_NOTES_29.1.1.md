# ERSEC 29.1.1 — Runtime, Performance and Kali UX
...
- **Packaging:** Python and Debian packaging now include the split runtime modules and identify the release as 29.1.1.
...
ERSEC 29.1.1 now includes a deterministic disposable multi-principal fixture compiler.
...
## Continued 29.1.1 roadmap build
...
- Added 29.1.1 stateful workflow examples and regression tests.
...
## 29.1.1 — Reproducible Assurance Benchmark Laboratory
...
- Added `ersec_assurance_loop.py` to compose reviewed policy, inventory, fixture truth, stateful assurance, metamorphic evidence, counterfactual evidence, Security Reality Fabric, Assurance Kernel, and Assurance Intelligence into one reproducible 29.1.1 bundle.
- Added explicit offline/safety governance and integrated digest semantics.
- Added `docs/integrated-assurance-loop-29.1.1.md` and an integrated example policy.
...
## 29.1.1 Maturity Closure — V19

The original 29.1.1 roadmap engineering scope is now closed at the implementation level.
...
- Focused 29.1.1 assurance/release suite: 90/90 passed.
...
- Closed the 29.1.1 roadmap coverage audit at 10/10 feature anchors covered.
...
ERSEC 29.1.1 now includes an explicit GitHub/PyPI publication procedure, a manual TestPyPI Trusted Publishing workflow, Debian `watch` metadata, stricter release-version consistency tests, and CI package-manifest checks for the newest assurance boundaries.
